...
> 💡 Caso o GitHub apresente instabilidade para renderizar o arquivo `.ipynb`, [clique aqui para visualizar o Notebook completo e interativo via NBViewer](https://nbviewer.org/github/xandevirgilio/projeto-avaliativo-ml-sctec-2026-/blob/main/projeto_ml.ipynb).
